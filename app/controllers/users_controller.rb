class UsersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @user.update(user_params)
        format.html { redirect_to users_url, notice: "User #{@user.username}'s Information was Successfully Updated !" }
  ...
  def destroy
    if @user.id != session[:user_id]
      ...
      redirect_to users_url, notice: "You Cannot Delete Your Own Admin User !"
      return
    end
